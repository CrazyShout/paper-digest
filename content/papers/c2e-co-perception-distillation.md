...
论文在 V2XSet、V2V4Real 和 DAIR-V2X 上验证 M2S，并声称在不引入在线通信成本的情况下，结合 CoSDH 和其他 3D detector 可带来最高 8.64% 的 3D mAP 增益。这个证据链比较贴合部署问题：它承认实时协同有成本，并尝试把协同收益转成离线知识。对组内来说，它适合作为“协同感知是否必须在线”的反向基线。
