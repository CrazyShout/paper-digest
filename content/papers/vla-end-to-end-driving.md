...
![原文 Fig. 1：OpenDriveVLA 的实例视觉与语言动作架构](../../assets/papers/vla-end-to-end-driving-figure-1.jpg)

三类视觉 token 经各自 projector 接入语言模型；输入历史状态与命令同样影响输出，图示未包含部署控制闭环。

![原文 Fig. 4：前行／右转指令与问答示例](../../assets/papers/vla-end-to-end-driving-figure-2.jpg)

这是同场景不同指令的开环规划可视化，不能从图中得到指令切换后的碰撞统计。
